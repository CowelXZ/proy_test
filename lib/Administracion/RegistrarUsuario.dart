...
class _RegistroUState extends State<RegistroU> {
  ...
  Future<void> saveUser() async {
    ...
    final rfc = rfcController.text;
    final usuario = usuarioController.text;
    final contrasena = contrasenaController.text;
    final confirmarContrasena = confirmarContrasenaController.text;
    final cumpleanos = cumpleanosController.text;
    final departamento = this.departamento;

    if (contrasena != confirmarContrasena) {
      // Puedes mostrar un mensaje de error si las contraseñas no coinciden
    ...
    try {
      final response = await http.post(
        Uri.parse(
            'http://localhost:3000/addUser'), // Asegúrate de que la URL esté correcta
